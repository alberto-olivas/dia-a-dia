...
function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen relative" style={{ overflowX: 'hidden', width: '100%', maxWidth: '100vw' }}>
      ...
      <main className="flex-1 flex flex-col min-h-screen relative" style={{ zIndex: 1, overflowX: 'hidden', minWidth: 0 }}>
